...
class App_Form_Abstract extends Zend_Form
{
	public $elementDecorators = array(
        'ViewHelper',
        array(array('alias1' => 'HtmlTag'),array('tag' => 'td', 'class' => 'input-field col s6 pull-l4' )),
	...
	public $buttonDecorators = array(
        'ViewHelper',
        array(array('alias1' => 'HtmlTag'), array('tag' => 'td', 'class' => 'btn orange waves-effect waves-light col s12 push-l3')),
        array(array('alias2' => 'HtmlTag'), array('tag' => 'tr')),
    	);

    public $buttonDecoratorsReg = array(
        'ViewHelper',
        array(array('alias1' => 'HtmlTag'), array('tag' => 'td', 'class' => 'btn orange waves-effect waves-light col s12 push-l12')),
        array(array('alias2' => 'HtmlTag'), array('tag' => 'tr')),
    );
